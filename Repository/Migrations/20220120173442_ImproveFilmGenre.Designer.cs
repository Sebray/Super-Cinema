...
namespace Repository.Migrations
{
    ...
    [Migration("20220120173442_ImproveFilmGenre")]
    partial class ImproveFilmGenre
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountryRegion", b =>
                {
                    b.HasOne("Buisness.Enties.Country", null)
                        .WithMany()
                        .HasForeignKey("CountriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Buisness.Enties.Region", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FilmGenre", b =>
                {
                    b.HasOne("Buisness.Enties.Film", null)
                        .WithMany()
                        .HasForeignKey("FilmsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Buisness.Enties.Genre", null)
                        .WithMany()
